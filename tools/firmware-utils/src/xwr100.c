/*
 * XWR100 - Firmware Generation Creator
 *
 * Creates a firmware image for the Vizio XWR100 router,
...
#define MAGIC		"VIZIO_247N"

// global variables
uint8_t kernelbuf[0x170000];	// kernel - lzma - uImage
uint8_t rootfsbuf[0x600000];	// root - squashfs

uint8_t buf[0x770000];		// buffer for image


// Header format:
//
//		GPL Tarball: http://www.vizio.com/documents/downloads/accessories/XWR100/VIZIO_GPL_Router_Codes.zip
//		File: VIZIO_GPL_Router_Codes/VIZIO_1.01.02/GTK/user/include/fw_upgrade.h
//
//
//		Struct:
//			typedef struct
